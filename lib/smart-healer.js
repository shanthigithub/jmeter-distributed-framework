  ...
  async click(selector, options = {}) {
    ...
    try {
      if (useML) {
        ...
        // Delegate to standalone healer - it will decide if healing is needed
        const healingBefore = this.standaloneHealer.stats.totalHealingTimeMs;
        console.log(`🔵 [HEALING-TIME-DEBUG] click() Before - standaloneHealer.stats.totalHealingTimeMs: ${healingBefore}ms`);
  ...
  async fill(selector, value, options = {}) {
    ...
    try {
      if (useML) {
        ...
        // Delegate to standalone healer - it will decide if healing is needed
        const healingBefore = this.standaloneHealer.stats.totalHealingTimeMs;
        console.log(`🔵 [HEALING-TIME-DEBUG] fill() Before - standaloneHealer.stats.totalHealingTimeMs: ${healingBefore}ms`);
  ...
  async waitFor(selector, options = {}) {
    ...
    try {
      if (useML) {
        ...
        // Delegate to standalone healer - it will decide if healing is needed
        const healingBefore = this.standaloneHealer.stats.totalHealingTimeMs;
        console.log(`🔵 [HEALING-TIME-DEBUG] waitFor() Before - standaloneHealer.stats.totalHealingTimeMs: ${healingBefore}ms`);
